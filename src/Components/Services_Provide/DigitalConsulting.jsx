...
import bgImage from '../../assets/Services_Provide/Digital Consulting.webp';
  ...
  return (
    <div className="service-page-wrapper font-sans bg-white min-h-screen flex flex-col">
      ...
      <div className="service-hero-banner relative w-full h-[350px] md:h-[450px] flex items-center justify-center mt-[90px]">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
          ...
          <div className="flex items-center gap-3 text-lg font-medium">
            ...
            <span className="text-white">Digital Consulting</span>
          </div>
        </div>
      ...
      <div className="flex-1 max-w-[1200px] w-full mx-auto px-4 py-20">
        <h2 className="text-3xl font-bold text-[#111827] mb-6">About Digital Consulting</h2>
        <p className="text-gray-600 leading-relaxed max-w-3xl">
          Detailed information and content for Digital Consulting will go here.
