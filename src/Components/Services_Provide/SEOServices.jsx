...
import bgImage from '../../assets/Services_Provide/Seo services.webp';
  ...
  return (
    <div className="service-page-wrapper font-sans bg-white min-h-screen flex flex-col">
      ...
      <div className="flex-1 max-w-[1200px] w-full mx-auto px-4 py-20">
        <h2 className="text-3xl font-bold text-[#111827] mb-6">About SEO Services</h2>
        <p className="text-gray-600 leading-relaxed max-w-3xl">
          Detailed information and content for SEO Services will go here.
